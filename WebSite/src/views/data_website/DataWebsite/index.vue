<template>
  <div class="data-website-container" :class="{ 'main-sidebar-collapsed': isMainSidebarCollapsed }">
    <!-- 二级左侧栏 -->
    <aside class="secondary-sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-content">
        ...
        <ul class="category-list">
          <li 
            :class="{ active: $route.name === 'MarketOverview' }"
            @click="navigateTo('/data-website/market-overview')"
          >
            <el-icon :size="18">
              <TrendCharts />
            </el-icon>
...
import { useDataWebsite } from './useDataWebsite.js'
...
/* 当主侧边栏收缩时，二级侧边栏也跟随调整 */
.data-website-container.main-sidebar-collapsed .secondary-sidebar {
  left: 4rem;
}
...
/* 当主侧边栏收缩时 */
.data-website-container.main-sidebar-collapsed .toggle-button {
  left: calc(4rem + 220px + 2px);
}

.data-website-container.main-sidebar-collapsed .toggle-button.collapsed {
  left: 4rem;
}
