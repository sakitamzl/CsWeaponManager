    ...
    <aside class="secondary-sidebar" :class="{ collapsed: sidebarCollapsed }">
      <div class="sidebar-content">
        ...
        <ul class="category-list">
          <li 
            :class="{ active: $route.name === 'OnSaleYYYP' }"
            @click="navigateTo('/on-sale/yyyp')"
          >
            <el-icon :size="18">
              <ShoppingCart />
            </el-icon>
          ...
          <li 
            :class="{ active: $route.name === 'OnSaleBuff' }"
            @click="navigateTo('/on-sale/buff')"
          >
            <el-icon :size="18">
              <ShoppingBag />
            </el-icon>
...
/* 当主侧边栏收缩时，二级侧边栏也跟随调整 */
.on-sale-container.main-sidebar-collapsed .secondary-sidebar {
  left: 4rem;
}
...
/* 当主侧边栏收缩时 */
.on-sale-container.main-sidebar-collapsed .toggle-button {
  left: calc(4rem + 220px + 2px);
}

.on-sale-container.main-sidebar-collapsed .toggle-button.collapsed {
  left: 4rem;
}
