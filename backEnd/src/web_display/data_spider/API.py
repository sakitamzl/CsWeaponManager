...
最终路径示例：
  POST /backENDV2/src/web_display/data_spider/search_weapon_rename/item/add
  GET  /backENDV2/src/web_display/data_spider/search_weapon_rename/items/list
  POST /backENDV2/src/web_display/data_spider/search_pendant/config/save
  GET  /backENDV2/src/web_display/data_spider/search_pendant/items/list
"""
