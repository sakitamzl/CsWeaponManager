...
# 导入所有模型
from .index import ConfigModel, FundsModel, BuyModel, SellModel, LeaseModel, LentModel, RentalModel, WeaponClassIDModel, AutoSearchWeaponModel, WeaponPriceHistoryModel
...
class DBManager:
    ...
    def _get_all_models(self) -> List[Type[BaseModel]]:
        ...
        return [
            ...
            WeaponPriceHistoryModel,  # 饰品价格历史表
