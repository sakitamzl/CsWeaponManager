...
最终路径示例：
  GET  /backENDV2/src/use_webside/settings/sys_message/list/<page>/<limit>
  GET  /backENDV2/src/use_webside/settings/sys_message/stats
  GET  /backENDV2/src/use_webside/settings/sys_message/types
  GET  /backENDV2/src/use_webside/settings/sys_message/sources
  POST /backENDV2/src/use_webside/settings/sys_message/mark_read
  POST /backENDV2/src/use_webside/settings/sys_message/mark_all_read
  POST /backENDV2/src/use_webside/settings/sys_message/delete
  POST /backENDV2/src/use_webside/settings/sys_message/search/keyword
  POST /backENDV2/src/use_webside/settings/sys_message/search/time
  POST /backENDV2/src/use_webside/settings/sys_message/search/filter
  POST /backENDV2/src/use_webside/settings/sys_message/create
"""
